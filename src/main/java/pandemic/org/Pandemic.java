...
public class Pandemic
{
	...
	ArrayList<ArrayList<PlayerCard>> decks = new ArrayList<ArrayList<PlayerCard>>();
	...
	if (firstWord.compareTo("one") == 0)
	    ...
	    {
		//done = true;
		ArrayList<InfectionCard> forecast = new ArrayList<InfectionCard>();
		...
		ArrayList<InfectionCard> reorder = new ArrayList<InfectionCard>();
		for (int i = 0; i < 6; i++)
		{
		    String line = in.nextLine();
		    int index = -1;
